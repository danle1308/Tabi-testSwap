import { ChainId, Pair, Token } from '@tabi-dex/sdk'
...
export function useGasPrice(): string {
  ...
  return chainId === ChainId.MAINNET.toString() ? '5000000000000' : GAS_PRICE_GWEI.testnet
}
...
export function toV2LiquidityToken([tokenA, tokenB]: [Token, Token]): Token {
  return new Token(tokenA.chainId, Pair.getAddress(tokenA, tokenB), 18, 'TBS-LP', 'TBS LPs')
}
