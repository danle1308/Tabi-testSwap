...
import { Button, useMatchBreakpoints, useModal, IconButton, AddIcon, MinusIcon } from 'packages/uikit'
      ...
      return (
        <IconButtonWrapper>
          <IconButton variant="secondary" onClick={handleWithdraw} mr="6px">
            <MinusIcon color="#2d5000" width="14px" />
          </IconButton>
          <IconButton variant="secondary" onClick={handleDeposit}>
            <AddIcon color="#2d5000" width="14px" />
          </IconButton>
        </IconButtonWrapper>
      )
    }
