...
import { Heading, Text, Button, ArrowForwardIcon, Link } from 'packages/uikit'
  ...
  const steps: Step[] = [
    {
      ...
      canHover: true,
      text: t('Unstake LP tokens and VEN from the old VENFarm contract.'),
    },
    {
      stepId: ProgressStepsType.STEP2,
      canHover: true,
      text: t('Stake LP tokens and VEN to the new VENFarm v2 contract.'),
    },
  ]
    ...
    <div ref={tableWrapperEl}>
      <PageHeader>
        ...
        <Heading scale="lg" color="text">
          {t('Migrate your stakings to the new VENFarm contract.')}
        </Heading>
        <Link href="/" external>
