...
const config = ({ t }: FAQsType) => [
  ...
  },
  {
    ...
    description: [
      t(
        'Wait for the reveal! After all 10,000 members of the TabiSwap Squad have been minted, their images will remain hidden for a few days. Just be patient :)',
      ),
    ],
  },
  {
    ...
    description: [
      ...
      t(
        'Users holding Gen 0 TabiSwap Bunny NFTs at the snapshot may also purchase one additional TabiSwap Squad NFT in the presale for each TabiSwap Bunny they hold.',
      ),
      t(
  ...
  },
  {
    ...
    description: [t('100% of VEN spent on TabiSwap Squad NFTs will be burned as part of our weekly VEN burn.')],
  },
  {
