  ...
  return [
    {
      ...
      bodyText: [t('You’ll need an active TabiSwap Profile to buy Minting Tickets and mint a TabiSwap Squad NFT!')],
      buttons: (
        <>
    ...
    },
    {
      ...
      title: t('Hold VEN'),
      bodyText: [t('Each NFT costs VEN to mint. Remember you also need VLX to cover transaction fees too!')],
      buttons: (
        <>
          <Button as="a" target="_blank" width="100%">
            {t('Buy VEN')}
          </Button>
        </>
      ),
    },
    {
      ...
      bodyText: [
        ...
        `04:00 UTC, Oct. 7 ${t(
          'Pre-sale: Wallets which held “Gen 0” TabiSwap Bunnies NFTs (bunnyID 0,1,2,3,4) at a snapshot taken some time between 12 and 2 hours before the presale begins can purchase one Squad Ticket per Gen 0 NFT.',
        )}`,
        `08:00 UTC, Oct. 7 ${t(
          'Public Sale: Any wallet with an active TabiSwap Profile can purchase up to 10 Squad Tickets, while stocks last.',
        )}`,
      ],
      buttons: (
        <>
    ...
    },
    {
      ...
      bodyText: [
        t(
          'During this phase, any wallet holding a Squad Ticket can redeem their ticket to claim a TabiSwap Squad NFT.',
        ),
      ],
      buttons: (
        <>
