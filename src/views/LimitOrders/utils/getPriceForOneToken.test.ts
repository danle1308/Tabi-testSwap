import { JSBI, Token, TokenAmount } from '@tabi-dex/sdk'
import getPriceForOneToken from './getPriceForOneToken'

const TALE = new Token(56, '0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82', 18, 'TALE', 'TaleSwap Token')
...
describe('limitOrders/utils/getPriceForOneToken', () => {
  describe.each([
    [new TokenAmount(WAG, ONE), new TokenAmount(BUSD, ONE), '1'],
    [new TokenAmount(WAG, FIVE), new TokenAmount(BUSD, FIVE), '1'],
    [new TokenAmount(WAG, ONE), new TokenAmount(BUSD, FIVE), '5'],
    [new TokenAmount(WAG, FIVE), new TokenAmount(BUSD, ONE), '0.2'],
    ...
    [new TokenAmount(WAG, ZERO), new TokenAmount(BUSD, ONE), undefined],
    [new TokenAmount(WAG, ONE), new TokenAmount(BUSD, ZERO), undefined],
