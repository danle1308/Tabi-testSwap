...
import { Text, Flex, Skeleton, Image } from 'packages/uikit'
  ...
  return (
    <Flex flexDirection={['column-reverse', null, 'row']}>
      <Flex flexDirection="column" flex="2" ref={observerRef}>
        {burnedCakeAmount !== 0 ? (
          <Balance fontSize="64px" bold value={burnedCakeAmount} decimals={0} unit="" />
        ) : (
      ...
      <Image width={350} height={320} src="/images/burnt-cake.png" alt={t('Burnt')} />
    </Flex>
  )
}
