...
import { Flex, Text, Skeleton, Button, ArrowForwardIcon } from 'packages/uikit'
...
const LotteryCardContent = () => {
  ...
  const cakePrizesText = t('%cakePrizeInUsd% in TABI prizes this round', { cakePrizeInUsd: cakePriceBusd.toString() })
    ...
    <>
      <Flex flexDirection="column" mt="48px">
        ...
        <Text color="white" mb="40px">
          {t('Buy tickets with TABI, win TABI if your numbers match')}
        </Text>
      </Flex>
