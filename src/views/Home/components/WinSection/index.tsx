...
import { Flex, Text, TicketFillIcon, PredictionsIcon } from 'packages/uikit'
...
const bottomLeftImage = {
  ...
  attributes: [
    { src: 'bottom-left', alt: 'TABI card' },
    { src: 'green', alt: 'Green TABI card with up arrow' },
    { src: 'red', alt: 'Red Cake card with down arrow' },
    { src: 'top-right', alt: 'TABI card' },
  ],
}
