...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and TABI pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and TABI pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from TABI pool', data)
  }
