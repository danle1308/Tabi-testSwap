...
import { Box, Flex, Text, Heading, useMatchBreakpoints, Link, Image } from 'packages/uikit'
  ...
  const steps: Step[] = [
    {
      ...
      title: t('Buy Tickets'),
      subtitle: t('Prices are set when the round starts, equal to 5 USD in VEN per ticket.'),
    },
    {
      ...
      <GappedFlex flexDirection={['column', 'column', 'column', 'row']}>
        <Flex flex="2" flexDirection="column">
          ...
          <BulletList>
            <li>
              <Text display="inline" color="textSubtle">
                {t('100% of the VEN paid by people buying tickets that round goes back into the prize pools.')}
              </Text>
            </li>
          </BulletList>
          <Heading my="16px" scale="md">
          ...
          <BulletList>
            <li>
              <Text display="inline" color="textSubtle">
                {t(
                  'After every round, if nobody wins in one of the prize brackets, the unclaimed VEN for that bracket rolls over into the next round and are redistributed among the prize pools.',
                )}
              </Text>
            </li>
          </BulletList>
          ...
          <BulletList>
            <li>
              <Text display="inline" color="textSubtle">
                {t(
                  'An average total of 35,000 VEN from the treasury is added to lottery rounds over the course of a week. This VEN is of course also included in rollovers! Read more in our guide to ',
                )}
                <InlineLink href="/">{t('VEN Tokenomics')}</InlineLink>
              </Text>
            </li>
          </BulletList>
        </Flex>
      ...
      <Flex justifyContent="center" alignItems="center" flexDirection={['column', 'column', 'row']}>
        <Flex maxWidth="300px" flexDirection="column">
          ...
          <Text>
            ...
            <InlineLink href="/">{t('how to play the TabiSwap lottery!')}</InlineLink>
          </Text>
        </Flex>
      </Flex>
    </Box>
