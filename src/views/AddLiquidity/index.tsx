...
import { Button, Text, AddIcon, CardBody, Message, useModal, Box, Flex, useMatchBreakpoints } from 'packages/uikit'
...
import { AppHeader, AppBody, AppHeaderAdd } from '../../components/App'
...
import CurrencyInputPanelPoolsAdd from '../../components/CurrencyInputPanelPoolsAdd'
...
export default function AddLiquidity() {
  ...
  return (
    <Page style={{ padding: isMobile ? '30px' : '' }}>
      <Box width="100%" maxWidth={['482px']} style={{ borderRadius: '15px' }}>
        <StyledAppBody>
          <AppHeaderAdd
          ...
          <CardBody p={['10px 20px 20px']}>
            <AutoColumn gap="20px">
              ...
              <Box>
                <Text
                  style={{ fontSize: '14px', fontWeight: '400', lineHeight: '20px', color: 'var(--color-white-80)' }}
                >
                  Select a pair
                </Text>
              </Box>
              <CurrencyInputPanelPoolsAdd
              ...
              {currencies[Field.CURRENCY_A] && currencies[Field.CURRENCY_B] && pairState !== PairState.INVALID && (
                <>
                  <LightCard style={{ background: 'none' }} mt="1.5rem" mb="0.5rem" padding="0px">
                    <RowBetween mb="8px">
                      <Text fontWeight="400" color="var(--color-white-80)" fontSize="14px">
          ...
          {!addIsUnsupported ? (
            pair && !noLiquidity && pairState !== PairState.INVALID ? (
              <AutoColumn style={{ minWidth: '20rem', width: '100%', maxWidth: '526px', padding: '20px' }}>
