import { Box, Card, CardBody, CardHeader, ExpandableButton, Flex, Text, Message, Button } from 'packages/uikit'
          ...
          <StyledCardBody>
            <Message variant="warning" mb="20px">
              <Flex flexDirection="column">
                <Text mb="16px">
                  {t(
                    'This is the old IFO TABI pool. Check out the brand new TABI pool to learn how to earn TABI rewards with higher APY while enjoying other benefits.',
                  )}
                </Text>
                <Flex ml="-34px">
                  <Button onClick={handleOnClick} width="100%">
                    {isShowMigrationButton ? t('Migrate') : t('Go to new TABI pool')}
                  </Button>
                </Flex>
              </Flex>
            </Message>
            <ActionContainer>
              ...
              <Box mt="24px">
                <Flex alignItems="center" justifyContent="space-between">
                  <Text fontSize="14px">{`${t('Recent %symbol% profit', { symbol: tokens.cake.symbol })}:`}</Text>
                  <Balance
                    bold
                    fontSize="14px"
