  ...
  return (
    <CardBody>
      ...
      <Heading as="h4" color="secondary" mb="16px">
        {t('Stake TABI in IFO pool')}
      </Heading>
      <Box>
        <Text color="textSubtle" small>
          {t(
            'The maximum amount of TABI user can commit to the Public Sale, is equal to the average TABI balance in the IFO TABI pool prior to the IFO. Stake more TABI to increase the maximum TABI you can commit to the sale. Missed this IFO? You can keep staking in the IFO TABI Pool to join the next IFO sale.',
          )}
        </Text>
...
const Step2 = () => {
  ...
  return (
    <CardBody>
      ...
      <Text color="textSubtle" small>
        {t('When the IFO sales are live, you can “commit” your TABI to buy the tokens being sold.')} <br />
      </Text>
    </CardBody>
  )
}
        ...
        return (
          <CardBody>
            ...
            <Text color="textSubtle" small mb="16px">
              {t('You’ll need an active TabiSwap Profile to take part in an IFO!')}
            </Text>
            {renderAccountStatus()}
          </CardBody>
        )
      ...
      case 3:
        return (
          <CardBody>
            ...
            <Text color="textSubtle" small>
              {t(
                'After the IFO sales finish, you can claim any IFO tokens that you bought, and any unspent TABI tokens will be returned to your wallet.',
              )}
            </Text>
          </CardBody>
        )
