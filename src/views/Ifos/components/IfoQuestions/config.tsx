...
const config = [
  {
    ...
    description: [
      <Trans>
        ...
        TABI up to the maximum commit limit, which is published along with the IFO voting proposal. The Private Sale has
        no participation fee.
      </Trans>,
      <Trans>
        In the Public Sale, everyone with an active TabiSwap profile can commit. However the maximum amount of TABI user
        can commit, is equal to the average TABI balance in the IFO TABI pool prior to the IFO. And there’s a fee for
  ...
  },
  {
    ...
    description: [
      ...
      <Trans>Just remember you need an active TabiSwap Profile in order to participate.</Trans>,
    ],
  },
  {
  ...
  },
  {
    ...
    description: [<Trans>The TABI from the participation fee will be burnt as part of the weekly token burn.</Trans>],
  },
  {
    title: <Trans>How can I get an achievement for participating in the IFO?</Trans>,
    description: [
      <Trans>You need to contribute a minimum of about 10 USD worth of TABI to either sale.</Trans>,
      <Trans>
