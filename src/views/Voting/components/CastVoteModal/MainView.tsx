import { IconButton, Text, Skeleton, Button, AutoRenewIcon, ChevronRightIcon, Message } from 'packages/uikit'
          ...
          <>
            ...
            {total === 0 ? (
              <Message variant="danger" mb="12px">
                <Text color="danger">
                  {t(
                    'Hold some TABI in your wallet or on TabiSwap at the snapshot block to get voting power for future proposals.',
                  )}
                </Text>
              </Message>
            ) : (
