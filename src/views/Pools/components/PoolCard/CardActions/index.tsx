    ...
    <Flex flexDirection="column">
      <Flex flexDirection="column">
        {harvest && (
          <>
            <Box display="inline">
              <InlineText color="WhiteColor" fontSize="14px">
        ...
        <Box display="inline">
          <InlineText color={isStaked ? 'WhiteColorLight' : 'textSubtle'} fontSize="14px">
            {isStaked ? stakingToken.symbol : t('Stake')}{' '}
          </InlineText>
          <InlineText color={isStaked ? 'textSubtle' : 'WhiteColorLight'} fontSize="14px">
