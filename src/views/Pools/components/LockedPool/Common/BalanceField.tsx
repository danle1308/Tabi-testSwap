import { BalanceInput, Flex, Image, Slider, Text } from 'packages/uikit'
    ...
    <>
      <Flex alignItems="center" justifyContent="space-between" mb="8px">
        ...
        <Flex alignItems="center" minWidth="70px">
          ...
          <Text ml="4px" color="WhiteColorLight">
            {stakingSymbol}
          </Text>
        </Flex>
      </Flex>
      ...
      <Text mt="8px" textAlign="end" color="WhiteColorLight" fontSize="12px" mb="8px">
