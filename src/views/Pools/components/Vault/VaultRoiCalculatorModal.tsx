import { Box, ButtonMenu, ButtonMenuItem } from 'packages/uikit'
...
import { TabButtonMenuItem } from 'components/TabiSwap/components/ui/Button/styles'
...
export const VaultRoiCalculatorModal = ({
  ...
  const buttonMenuItems = useMemo(
    () => [
      <TabButtonMenuItem key="Flexible">{t('Flexible')}</TabButtonMenuItem>,
      <TabButtonMenuItem key="Locked">{t('Locked')}</TabButtonMenuItem>,
    ],
    [t],
  )
