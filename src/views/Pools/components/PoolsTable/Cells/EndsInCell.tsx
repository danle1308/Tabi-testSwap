...
import { Flex, Link, Skeleton, Text, TimerIcon, useMatchBreakpoints } from 'packages/uikit'
  ...
  const renderBlocks = shouldShowBlockCountdown ? (
    <Flex alignItems="center">
      <Flex flex="1.3">
        ...
        <RemainingTime ellipsis fontSize={isMobile ? '0.675rem' : '0.875rem'} value={blocksToDisplay} />
      </Flex>
      <Flex flex="1">
        {/* <Link
          external
