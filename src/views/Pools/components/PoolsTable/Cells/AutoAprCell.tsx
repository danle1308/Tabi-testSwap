import { Skeleton, Text, Flex, Button, CalculateIcon, useModal, useMatchBreakpoints } from 'packages/uikit'
              ...
              <AprLabelContainer alignItems="center" justifyContent="flex-start">
                ...
                {/* {!isMobile && (
                  <Button
                    ...
                    marginLeft="4px"
                  >
                    <CalculateIcon width="20px" color="MainColor" />
                  </Button>
                )} */}
              </AprLabelContainer>
            ) : (
            ...
            {lockedApy ? (
              <AprLabelContainer alignItems="center" justifyContent="flex-start">
                <FlexGap gap="4px" flexWrap="wrap">
                  <Text fontSize={['14px', '14px', '16px']} style={{ whiteSpace: 'nowrap' }} fontWeight={[600, 500]}>
                    {t('Upto')}
                  </Text>
                  <Balance
                    fontSize={['14px', '14px', '16px']}
