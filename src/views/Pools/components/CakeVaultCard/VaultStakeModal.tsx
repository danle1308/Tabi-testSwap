...
const VaultStakeModal: React.FC<VaultStakeModalProps> = ({
  ...
  const handleWithdrawal = async () => {
    // trigger withdrawAll function if the withdrawal will leave 0.00001 TABI or less
  ...
  return (
    ...
    >
      ...
      />
      <Text mt="8px" ml="auto" color="WhiteColorLight" fontSize="12px" mb="8px">
      ...
      {!isRemovingStake && (
        <Link external href={getTokenLink}>
