import { Flex, Text, IconButton, AddIcon, MinusIcon, useModal, Skeleton, Box } from 'packages/uikit'
...
const HasSharesActions: React.FC<HasStakeActionProps> = ({ pool, stakingTokenBalance, performanceFee }) => {
  ...
  // console.log('🚀 ~ file: HasSharesActions.tsx:22 ~ cakeAsNumberBalance:', cakeAsNumberBalance)
  // console.log('🚀 ~ file: HasSharesActions.tsx:22 ~ cakeAsBigNumber:', cakeAsBigNumber)
      ...
      <Flex mb="16px" justifyContent="space-between" alignItems="center">
        ...
        <Flex>
          <IconButton style={{ border: '0' }} variant="secondary" onClick={onPresentUnstake} mr="6px">
            <MinusIcon style={{ border: '2px solid #fff', borderRadius: '50px' }} color="MainColor" width="24px" />
          </IconButton>
          <IconButton
            style={{ border: '0' }}
            variant="secondary"
