...
export { default as VelasIcon } from './Icons/Velas'
export { default as Svg } from './Svg'
export type { SvgProps } from './types'
export { default as TelosIcon } from './Icons/Telos'
export { default as Scroll } from './Icons/Scroll'
export { default as LinkIcon } from './Icons/LinkIcon'
export { default as NewArrowDown } from './Icons/NewArrowDown'
export { default as AutoRenewRedIcon } from './Icons/AutoRenewRed'
export { default as LoadingIcon } from './Icons/LoadingIcon'
export { default as CircleAddIcon } from './Icons/CircleAdd'
export { default as SecondWalletIcon } from './Icons/WalletIcon'
export { default as MenuIcon } from './Icons/MenuIcon'
export { default as SelectIcon } from './Icons/Select'
export { default as NewLinkIcon } from './Icons/NewLink'
