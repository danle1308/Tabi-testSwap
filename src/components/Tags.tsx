...
const CoreTag: React.FC<TagProps> = (props) => {
  ...
  return (
    <Tag variant="venus" startIcon={<VerifiedIcon width="26px" color="var(--core-color)" />} {...props}>
      {t('Core')}
    </Tag>
  )
}
...
const ManualPoolTag: React.FC<TagProps> = (props) => {
  const { t } = useTranslation()
  return (
    <Tag variant="primary" startIcon={<RefreshIcon width="18px" color="BlackColor" mr="4px" />} {...props}>
      {t('Manual')}
    </Tag>
  )
}
...
const CompoundingPoolTag: React.FC<TagProps> = (props) => {
  const { t } = useTranslation()
  return (
    <Tag variant="primary" startIcon={<AutoRenewIcon width="18px" color="BlackColor" mr="4px" />} {...props}>
      {t('Auto')}
    </Tag>
  )
}
